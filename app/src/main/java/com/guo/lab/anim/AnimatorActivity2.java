...
public class AnimatorActivity2 extends AppCompatActivity {
    ...
    private PowerSaveMultiRingRotateView powerSaveMultiRingRotateView;
...
//        });
        ...
        powerSaveMultiRingRotateView = (PowerSaveMultiRingRotateView) findViewById(R.id.multi_ring);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.start:
                View view1 = findViewById(R.id.dont_know);
                ObjectAnimator.ofFloat(view1, View.TRANSLATION_X, 200)
                        .setDuration(2000)
                        .start();
//                view1.animate()
//                        .translationY(200)
...
//                ringProgressView.start();
                break;
            case R.id.end:
                powerSaveMultiRingRotateView.end();
